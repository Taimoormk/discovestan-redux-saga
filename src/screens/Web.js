...
import { readWebPostsAction } from '../actions';
...
class Web extends Component {
  ...
  componentDidMount() {
    let { readWebPostsAction } = this.props;
    readWebPostsAction();
  }
      ...
      <Container>
        ...
        <ListView
          ...
          renderRow={
            (rowData) =>
              <View>
                <TouchableOpacity onPress={() => this.props.navigation.navigate('WebDetails', { rowData })}>
                  <Card>
                    <CardItem header>
...
export default connect(mapStateToProps, { readWebPostsAction })(Web);